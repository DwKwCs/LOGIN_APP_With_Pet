...
class GuideDiet extends StatefulWidget {
  const GuideDiet({super.key});

  @override
  State<GuideDiet> createState() => _GuideDietState();
}

class _GuideDietState extends State<GuideDiet> {
  ...
  Future<List<Map<String, dynamic>>> fetchGuides() async {
    return await dbHelper.getGuides('음식');
  }
